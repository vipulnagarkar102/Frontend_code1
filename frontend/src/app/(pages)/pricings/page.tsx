...
const Pricings = () => {
  return (
    <div className='mt-26 [@media(min-width:1750px)]:mt-36 font-lato text-[#003F5C]'>
      ...
      <div className="mx-8 my-12 flex flex-wrap gap-10 items-center justify-center">
        <div className="w-[280px] h-[400px] [@media(min-width:1750px)]:w-[380px] [@media(min-width:1750px)]:h-[480px] rounded-[30px] text-white font-poppins font-semibold text-[32px] [@media(min-width:1750px)]:text-[42px] bg-[#003F5C] flex flex-col justify-between p-8 gap-6 hover:scale-105 transition-transform duration-200 border border-[#00A5CF]/20 shadow-md">
              ...
              <div>
                ...
                <p className='font-lato text-[16px] [@media(min-width:1750px)]:text-[22px] text-white font-normal'>No credit card required</p>
              </div>
              <div>
              <Button className='font-lato py-4 font-semibold text-[16px] [@media(min-width:1750px)]:text-[22px] cursor-pointer bg-[#00A5CF] hover:bg-[#00A5CF] text-[#FFFFFF] leading-[100% '>START FOR FREE <span className='rotate-225'><ArrowDown size={30}/></span></Button>
              </div>
            </div>
      ...
      <p className='mt-20 font-poppins font-normal text-[16px] [@media(min-width:1750px)]:text-[22px] px-4 sm:px-12 md:px-42 text-center'>The prices listed above do not incorporate the taxes applicable based on your billing location. The total amount payable will be shown on the checkout page prior to finalizing your payment.</p>
      
      <div className='mx-4'>
        <p className='font-poppins font-semibold text-[40px] [@media(min-width:1750px)]:text-[60px] mt-10 text-center px-4 [@media(min-width:1750px)]:mb-4'>Compare All Plan Features</p>
        <PlanFeatures/>
      </div>
...
{/* 
      ...
      <div className='mx-4'>
        <div className="border-2 border-dashed border-gray-400 rounded-xl p-6 bg-[#E0F7FA] text-[#003F5C] max-w-[1360px] [@media(min-width:1750px)]:max-w-[1700px] my-18 mx-auto flex flex-col">
          <div className="flex flex-col md:flex-row justify-between">
            <div>
              <h2 className="text-[40px] [@media(min-width:1750px)]:text-[56px] font-poppins font-semibold mb-3">Enterprise Plan</h2>
            </div>
            <div>
              <Button className='font-lato py-4 font-semibold text-[16px] [@media(min-width:1750px)]:text-[22px] cursor-pointer bg-[#00A5CF] hover:bg-[#00A5CF] text-[#FFFFFF] leading-[100%]'>CONTACT US<span className='rotate-225'><ArrowDown size={30}/></span></Button>
            </div>
          </div>

          <div className='flex flex-col md:flex-row gap-10 md:gap-16 mt-12'>
            <div className='md:w-1/2'>
              <p className="mb-6 font-lato text-[18px] md:text-[20px] [@media(min-width:1750px)]:text-[26px] font-normal">
            ...
            <div className="md:w-1/2 space-y-4 font-lato font-normal text-[18px] [@media(min-width:1750px)]:text-[26px]">
