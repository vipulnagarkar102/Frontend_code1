  ...
  return (
    <div className="mt-30 max-w-8xl px-3 md:px-6 py-10 font-lato text-[#003F5C]">
      <div className="flex flex-col gap-4">
        ...
        <h1 className="text-4xl md:text-5xl text-center font-poppins font-semibold mb-6">
          {term.title}
        </h1>

        {term.id === "terms-of-use-preamble" && (
          <div>
            <p className="text-[15px] md:text-[18px] font-lato font-normal leading-relaxed">
          ...
          <p className='text-center mt-8 text-[18px]'> -----End of Terms of Use Preamble-----</p>
        </div>
        )}
